...
sudo ln -s /home/pi/stepic_web_project/web/etc/rpi-nginx.conf  /etc/nginx/sites-enabled/test.conf
...
echo "creating simlinks"
sudo ln -s /home/pi/stepic_web_project/etc/rpi-hello-gunicorn.config /etc/gunicorn.d/hello.config
sudo ln -s /home/pi/stepic_web_project/etc/rpi-django-gunicorn.config /etc/gunicorn.d/django.config
